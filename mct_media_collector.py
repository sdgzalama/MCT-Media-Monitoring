...
# ------------------------------
# Define RSS sources (Top 20 in Tanzania)
# ------------------------------
FEEDS = [
    # --- Major National Outlets ---
    "https://www.mwananchi.co.tz/feeds/rss.xml",       # Mwananchi
    "https://www.thecitizen.co.tz/feeds/rss.xml",      # The Citizen
    "https://habarileo.co.tz/feed",                    # HabariLeo
    "https://www.dailynews.co.tz/feed",                # Daily News Tanzania
    "https://www.ippmedia.com/en/feed",                # IPP Media
    "https://mtanzania.co.tz/feed/",                   # Mtanzania
    "https://www.mwanahalisionline.com/feed/",         # Mwanahalisi Online
    "https://millardayo.com/feed/",                    # Millard Ayo
    "https://dar24.com/feed/",                         # Dar24 News
    "https://bongo5.com/feed/",                        # Bongo5 Entertainment/News
    "https://www.globalpublishers.co.tz/feed/",        # Global Publishers (Uwazi, Amani)
    "https://sautikubwa.org/feed/",                    # Sauti Kubwa (Investigative)
    "https://zanzibar24.co.tz/feed/",                  # Zanzibar24
    "https://www.swahilitimes.co.tz/feed/",            # Swahili Times
    "https://kivumbinews.co.tz/feed/",                 # Kivumbi News
    "https://thechanzo.com/feed/",                     # The Chanzo
    "https://www.bbc.com/swahili/index.xml",           # BBC Swahili
    "https://www.voaswahili.com/rss",                  # VOA Swahili
    "https://www.dw.com/overlay/rss/tz",               # DW Kiswahili
    "https://allafrica.com/tools/headlines/rdf/tanzania/headlines.rdf"  # AllAfrica Tanzania Section
]
